...
async function getStats(supabase: any, businessId: string) {
  const data = await getStatsData(supabase, businessId)
...
async function getSalesChart(supabase: any, businessId: string) {
  const data = await getSalesChartData(supabase, businessId)
...
async function getPaymentMethods(supabase: any, businessId: string) {
  const data = await getPaymentMethodsData(supabase, businessId)
  return NextResponse.json(data)
}
...
async function getTopProducts(supabase: any, businessId: string) {
  const data = await getTopProductsData(supabase, businessId)
  return NextResponse.json(data)
}
...
async function getTransactions(supabase: any, businessId: string) {
  const data = await getTransactionsData(supabase, businessId)
  return NextResponse.json(data)
}

async function getLowStockData(supabase: any, businessId: string) {
  // Fetch products with low stock (current_stock < reorder_level)
  const { data: products } = await supabase
    .from('products')
    .select('id, name, sku, current_stock, reorder_level, image_url')
    .eq('business_id', businessId)
...
async function getBusinessStats(supabase: any, businessId: string) {
  const data = await getBusinessStatsData(supabase, businessId)
  return NextResponse.json(data)
}
