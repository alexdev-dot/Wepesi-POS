...
export default function CashRegisterPage() {
  ...
  return (
    <div className="flex h-screen bg-background font-sans">
          ...
          <div className="px-4 sm:px-6 py-4 sm:py-5">
            <div className="max-w-7xl mx-auto">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl font-semibold text-foreground">Cash Register</h1>
                  <p className="text-sm sm:text-base text-muted-foreground mt-0.5">Manage cash flow and transactions</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex items-center gap-2 px-3 py-2 border border-border rounded-lg bg-card shadow-sm">
                  ...
                  <span className="text-sm sm:text-base text-foreground">Today, 31 May 2025</span>
                </div>

                {/* Action Buttons */}
                <div className="flex flex-wrap gap-2 ml-auto">
                  <button className="flex items-center gap-2 px-3 py-2 border border-border rounded-lg bg-card text-sm sm:text-base text-foreground hover:bg-muted transition-all shadow-sm">
            ...
            <div className="max-w-7xl mx-auto space-y-6">
              ...
              <div className="grid gap-3 sm:gap-4 grid-cols-2 lg:grid-cols-5">
                {balanceStats.map((stat) => (
                  <div key={stat.title} className="rounded-xl border border-border bg-card p-4 sm:p-5 shadow-sm hover:shadow-md transition-all duration-200">
                    ...
                    <div>
                      <h4 className="text-sm sm:text-base font-semibold text-foreground">{stat.title}</h4>
                      <p className="mt-2 text-lg sm:text-xl font-bold text-foreground">{stat.value}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
                <div className="px-4 sm:px-6 py-4 border-b border-border bg-muted flex items-center justify-between">
                  ...
                  <span className="text-sm sm:text-base text-muted-foreground">6 transactions today</span>
                </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border">
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-muted-foreground uppercase">Type</th>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-muted-foreground uppercase">Description</th>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-muted-foreground uppercase">Amount</th>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-muted-foreground uppercase">Time</th>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-muted-foreground uppercase">Cashier</th>
                        <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-muted-foreground uppercase">Actions</th>
                      </tr>
                    </thead>
                        ...
                        <tr key={transaction.id} className="hover:bg-muted transition-colors">
                          <td className="px-4 sm:px-6 py-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm sm:text-base font-medium capitalize text-foreground">{transaction.type.replace('-', ' ')}</span>
                            </div>
                          </td>
                          <td className="px-4 sm:px-6 py-4 text-sm sm:text-base text-foreground">{transaction.description}</td>
                          ...
                          <td className="px-4 sm:px-6 py-4 text-sm sm:text-base text-foreground">{transaction.time}</td>
                          <td className="px-4 sm:px-6 py-4 text-sm sm:text-base text-foreground">{transaction.cashier}</td>
                          <td className="px-4 sm:px-6 py-4">
                ...
                <div className="md:hidden px-4 sm:px-6 py-4 space-y-3">
                  {transactions.map((transaction) => (
                    <div key={transaction.id} className="bg-card border border-border rounded-xl p-4 shadow-sm">
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <span className="text-sm sm:text-base font-semibold text-foreground capitalize">{transaction.type.replace('-', ' ')}</span>
                          </div>
                          <p className="text-xs sm:text-sm text-muted-foreground mt-0.5">{transaction.description}</p>
                        </div>
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-border text-xs sm:text-sm text-muted-foreground">
              ...
              <div className="rounded-xl border border-border bg-card p-4 sm:p-6 shadow-sm">
                ...
                <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                  <Button variant="outline" className="h-12 border-border text-foreground hover:bg-muted">
      ...
      {isCashInOpen && (
        <>
          <div className="fixed inset-0 bg-background/80 z-40" onClick={() => setIsCashInOpen(false)} />
            ...
            <div className="bg-card rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <Input type="number" placeholder="Enter amount" className="h-10 sm:h-11 px-3 text-sm sm:text-base border border-slate-200 bg-card text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all" />
                </div>
                <div>
                  <label className="block text-sm sm:text-base font-medium text-slate-700 mb-1.5">Description</label>
                  <Input type="text" placeholder="e.g., Cash deposit" className="h-10 sm:h-11 px-3 text-sm sm:text-base border border-slate-200 bg-card text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all" />
                </div>
      ...
      {isCashOutOpen && (
        <>
          <div className="fixed inset-0 bg-background/80 z-40" onClick={() => setIsCashOutOpen(false)} />
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="bg-card rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
              <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
                <div className="flex items-center gap-3">
              ...
              <div className="p-6 space-y-4">
                <div>
                  <label className="block text-sm sm:text-base font-medium text-slate-700 mb-1.5">Amount</label>
                  <Input type="number" placeholder="Enter amount" className="h-10 sm:h-11 px-3 text-sm sm:text-base border border-slate-200 bg-card text-slate-700 focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-all" />
                </div>
                <div>
                  <label className="block text-sm sm:text-base font-medium text-slate-700 mb-1.5">Description</label>
                  <Input type="text" placeholder="e.g., Petty cash withdrawal" className="h-10 sm:h-11 px-3 text-sm sm:text-base border border-slate-200 bg-card text-slate-700 focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-all" />
                </div>
                <div className="flex gap-3 pt-4">
