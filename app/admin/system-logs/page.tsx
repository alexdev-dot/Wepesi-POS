    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-800">System Health & Logs</h1>
            <p className="text-slate-600">Monitor system health and view activity logs</p>
          </div>
        </div>
            ...
            {services.map((service) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-medium text-slate-800">{service.name}</h3>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200">
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">Message</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">User ID</th>
