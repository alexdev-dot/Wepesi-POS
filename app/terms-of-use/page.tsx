              ...
              <ScrollReveal className="mb-12">
                ...
                >
                  ...
                  <motion.div 
                    ...
                    transition={{ delay: 0.3 }}
                    whileHover={{ scale: 1.02 }}
                    className="bg-linear-to-r from-primary/5 to-blue-50 rounded-xl p-6 border border-primary/20 hover:shadow-lg transition-all duration-300"
                  >
                    <p className="text-slate-700 leading-relaxed mb-4">
                    ...
                    <ul className="space-y-3 text-slate-600">
                      {[
                        ...
                        "Wepesi POS retains all rights to the Service and its content",
              ...
              <ScrollReveal className="mb-12">
                ...
                >
                  ...
                  <motion.div 
                    ...
                    transition={{ delay: 0.3 }}
                    whileHover={{ scale: 1.02 }}
                    className="bg-linear-to-r from-primary/10 to-blue-50 rounded-xl p-6 border border-primary/20 hover:shadow-lg transition-all duration-300"
                  >
                    <p className="text-slate-700 leading-relaxed mb-4">
                ...
                >
                  ...
                  >
                    ...
                    <div className="space-y-2 text-slate-600">
                      ...
                      >
                        <strong>Email:</strong> wepesipos@gmail.com
                      </motion.p>
                      <motion.p 
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
