          ...
          <div className="px-4 sm:px-6 py-4 sm:py-5">
            <div className="max-w-7xl mx-auto">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h1 className="text-lg sm:text-xl font-semibold text-slate-900">Suppliers</h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="relative flex-1 max-w-md">
                  ...
                  <Input
                    ...
                    className="h-10 pl-9 sm:pl-10 text-sm border border-slate-200 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500/20 transition-all"
                  />
                </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-slate-200">
                        <th className="px-4 sm:px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase">Supplier</th>
                        ...
                        <th className="px-4 sm:px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase">Rating</th>
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {suppliers.map((supplier) => (
                        <tr key={supplier.id} className="hover:bg-slate-50 transition-colors">
                          ...
                          <td className="px-4 sm:px-6 py-4 text-sm text-slate-700">{supplier.category}</td>
                          <td className="px-4 sm:px-6 py-4">
                          ...
                          <td className="px-4 sm:px-6 py-4 text-sm text-slate-900 font-semibold">{supplier.totalOrders}</td>
                          <td className="px-4 sm:px-6 py-4">
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg overflow-hidden">
              <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Add a new supplier</p>
                  </div>
                </div>
                <button onClick={() => setIsAddSupplierOpen(false)} className="p-2 hover:bg-slate-100 rounded-lg transition-colors">
              ...
              <div className="p-4 sm:p-6 space-y-4 overflow-y-auto flex-1">
                ...
                <div>
                  ...
                  <Input type="email" placeholder="Enter email address" className="h-10 px-3 text-sm border border-slate-200 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500/20 transition-all" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1.5">Phone</label>
                  <Input type="tel" placeholder="Enter phone number" className="h-10 px-3 text-sm border border-slate-200 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500/20 transition-all" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-1.5">Address</label>
                  <Input type="text" placeholder="Enter address" className="h-10 px-3 text-sm border border-slate-200 bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500/20 transition-all" />
                </div>
                <div className="grid gap-4 grid-cols-2">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1.5">Category</label>
                    <select className="w-full px-3 py-2.5 text-sm border border-slate-200 rounded-lg bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-500/20 transition-all">
                ...
                <div className="flex gap-3 pt-4">
                  <Button variant="outline" onClick={() => setIsAddSupplierOpen(false)} className="flex-1 h-10 border-slate-200 text-slate-700 hover:bg-slate-50">Cancel</Button>
