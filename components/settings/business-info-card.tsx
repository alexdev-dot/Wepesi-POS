    ...
    <div className="rounded-xl border border-border bg-card p-4 sm:p-5 shadow-sm hover:shadow-md transition-all duration-200">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Update your business details</p>
        </div>
      </div>
      <div className="space-y-4">
        <div>
          ...
          <Input
            ...
            className="h-10 text-sm border bg-muted focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
          />
        </div>
        <div>
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-1.5">Website Subdomain</label>
          <div className="relative">
            <Input
              ...
              className="h-10 text-sm border bg-muted focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all pr-24"
              placeholder="mybusiness"
            />
            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-muted-foreground font-medium">.wepesi.com</span>
          </div>
          <p className="mt-1.5 text-xs text-muted-foreground">Your website will be: <span className="font-medium text-blue-600 ">{businessInfo.subdomain || 'mybusiness'}.wepesi.com</span></p>
        </div>
        <div>
          <label className="block text-sm font-medium text-foreground mb-1.5">Business Logo</label>
          <div className="flex items-center gap-3">
            <Button variant="outline" size="sm" className="h-10 text-sm border-border text-foreground hover:bg-muted">
