...
export function AdminHeader({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    <header className="flex h-16 sm:h-18 items-center justify-between border-b border-slate-200 bg-card px-4 sm:px-6 font-sans shadow-sm">
      {/* Left Side - Hamburger */}
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-3 rounded-lg bg-slate-50 px-3 py-2 sm:px-4 sm:py-2.5 hover:bg-slate-100 transition-all cursor-pointer border border-slate-200">
            <div className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-navy text-card shadow-sm">
