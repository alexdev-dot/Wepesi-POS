            ...
            {plans.map(plan => (
              ...
              >
                <div className="text-center">
                  <p className="font-medium text-slate-800">{plan.value}</p>
                  <p className="text-sm text-slate-600">${plan.price}/mo</p>
                  {formData.plan === plan.value && (
            ...
            <table className="w-full">
              <thead className="bg-slate-50">
                <tr>
                  ...
                  <th className="px-4 py-2 text-left text-xs font-semibold text-slate-600 w-24">Quantity</th>
                  <th className="px-4 py-2 text-left text-xs font-semibold text-slate-600 w-28">Price</th>
                  <th className="px-4 py-2 text-left text-xs font-semibold text-slate-600 w-28">Total</th>
                  <th className="px-4 py-2 text-right text-xs font-semibold text-slate-600 w-12"></th>
                </tr>
              </thead>
                  ...
                  <tr key={item.id}>
                    <td className="px-4 py-2">
                      <input
                        ...
                        className="w-full px-3 py-1.5 border border-slate-200 rounded focus:outline-none focus:ring-2 focus:ring-green-500/20 text-sm"
                      />
                    </td>
                    <td className="px-4 py-2">
                      <input
                    ...
                    <td className="px-4 py-2">
                      <div className="relative">
                        ...
                        <input
                          ...
                          min="0"
                          step="0.01"
                          className="w-full pl-6 pr-3 py-1.5 border border-slate-200 rounded focus:outline-none focus:ring-2 focus:ring-green-500/20 text-sm"
                        />
                      </div>
                    </td>
                    <td className="px-4 py-2">
                      <span className="text-sm font-medium text-slate-800">${item.total.toFixed(2)}</span>
                    </td>
