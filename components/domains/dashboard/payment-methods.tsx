...
interface PaymentMethodsProps {
  data?: { paymentMethods: PaymentMethod[]; totalAmount: number } | null
  isLoading?: boolean
}

export function PaymentMethods({ data, isLoading = true }: PaymentMethodsProps) {
          ...
          {paymentMethods.length > 0 ? paymentMethods.map((method, index) => (
            ...
            >
              ...
              <div className="text-right ml-4">
                <p className="text-xs font-semibold text-foreground">{formatCurrency(method.amount)}</p>
