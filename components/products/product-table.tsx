  ...
  return (
    <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
        ...
        <table className="w-full min-w-225">
          ...
          <tbody className="divide-y divide-border">
            {products.map((product) => (
              <tr key={product.id} className="hover:bg-muted transition-colors group">
      ...
      <div className="md:hidden px-4 sm:px-6 py-4 space-y-3">
        {products.map((product) => (
          <div key={product.id} className="bg-card border border-border rounded-xl p-4 shadow-sm">
            ...
            <div className="flex items-center justify-between pt-3 border-t border-border">
              <div>
                ...
                <p className="text-sm font-bold text-foreground">KSh {product.sellingPrice.toFixed(2)}</p>
              </div>
              <div className="flex items-center gap-1">
                <button 
      ...
      <div className="px-4 sm:px-6 py-4 border-t border-border bg-card flex flex-col sm:flex-row items-center justify-between gap-3">
        <p className="text-xs sm:text-sm text-muted-foreground">Showing 1 to {products.length} of 1,248 entries</p>
