      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:gap-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor="remember" className="text-xs sm:text-sm font-medium text-slate-700">
              Remember me
            </Label>
          </div>
          <a href="#" className="text-xs sm:text-sm font-semibold text-[#30B54A] hover:text-[#25913b] transition-colors">
            Forgot password?
          </a>
        </div>
